...
public class AcceptedEventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_show_accepted_events, container, false);
        RecyclerView eventsList = (RecyclerView)rootView.findViewById(R.id.events_accepted_recycler_view);
    ...
    public void onResume() {
        ...
        if (this.getView() != null) {
            RecyclerView eventsList = (RecyclerView) this.getActivity().findViewById(R.id.events_accepted_recycler_view);
